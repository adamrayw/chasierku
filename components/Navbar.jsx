    ...
    return (
        ...
        <>
            <nav className="fixed bottom-0 inset-x-0 bg-black border-t border-blue-300 flex justify-between text-sm text-white uppercase font-mono">
                ...
                <Link href="/statistik" >
                    <a className={`w-full block py-5 px-3 text-center ${(path === '/statistik') ? 'text-white' : 'text-gray-700'} focus:text-white hover:text-white transition`}>
                ...
                active ? (
                    index === 0 ? (
                        ...
                        <div className={`modal fixed w-full h-full top-0 left-0 flex items-center justify-center`} >
                            ...
                            <div className="modal-container bg-white w-10/12 md:w-6/12 mx-auto rounded shadow-lg z-10 overflow-y-auto">
